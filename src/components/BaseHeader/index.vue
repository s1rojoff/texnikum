...
<template>
  <div class="bg-white">
    <div class="lg:px-24 md:px-7 mx-auto container md:flex md:items-center md:justify-between">
      <p class="lg:uppercase lg:text-xs lg:font-semibold text-main lg:py-4 md:py-3">
        TOSHKENT TEMIR YO'L TEXNIKUMI
      </p>
      <div class="md:flex md:items-center md:justify-end lg:gap-6 md:gap-3">
  ...
  <div class="bg-[#E2F0F9]">
    ...
    >
      <BaseIcon class="lg:w-7 lg:h-7 cursor-pointer" @click="toggleNavbar" name="dashboard" />
      <p
